                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    <label class="form-label">IGD Pra R.Inap</label>
                        ...
                        <hr>
                        <div class="row">
                            <h4>INFO <span class="fw-bold">RUANG</span></h4>
                            <div class="col-sm-4 mt-3">
                                <div class="mb-3">
                                    <label class="form-label">Nama Keluarga Terdekat</label>
                                    <input type="text" class="form-control" placeholder="Nomor MR">
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    <label for="tenaga_medis" class="form-label">Dokter Penanggung Jawab Pasien</label>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="tenaga_medis">
                                        <option selected disabled>--Pilih--</option>
                                        <option>Rindu A</option>
                                        <option>Rindu B</option>
                                        <option>Rindu C</option>
                                        <option>Rindu D</option>
                                    </select>
                                </div>
                            </div><!-- Col -->
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="nama_kamar">
                                        <option selected disabled>--Pilih--</option>
                                    </select>
